...
class _KonversiHariWetonPageState extends State<KonversiHariWetonPage> {
  ...
  Future<void> _pickDate() async {
    ...
    // Referensi: 2 April 2026 = Kamis Wage (index Wage = 3)
    final referenceDate = DateTime(2026, 4, 2);
    const int referencePassaranIndex = 3; // Wage
    final int dayDifference = normalizedDate.difference(referenceDate).inDays;
    final int pasaranIndex =
        ((dayDifference + referencePassaranIndex) % 5 + 5) % 5;
